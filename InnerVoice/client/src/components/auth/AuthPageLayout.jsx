...
import { Lock, Eye, EyeOff, Check, Shield, Sparkles, ArrowRight, Loader2 } from "lucide-react";
            ...
            <form onSubmit={handleSubmit} className="space-y-4 pt-1">
              ...
              <div className="flex items-center gap-4 pt-1">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    type="button"
                    onClick={() => alert("Social sign-in with Apple")}
                  ...
                  <button
                    type="button"
                    onClick={() => alert("Social sign-in with Google")}
                    className="w-8 h-8 rounded-full bg-white/5 hover:bg-white/15 border border-white/10 flex items-center justify-center text-slate-300 hover:text-white transition cursor-pointer"
                  ...
                  <button
                    type="button"
                    onClick={() => alert("Social sign-in with GitHub")}
                    className="w-8 h-8 rounded-full bg-white/5 hover:bg-white/15 border border-white/10 flex items-center justify-center text-slate-300 hover:text-white transition cursor-pointer"
