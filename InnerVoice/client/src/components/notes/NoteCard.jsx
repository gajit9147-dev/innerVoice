...
function NoteCard({ note, onDelete, onEdit, onPin, onFavorite }) {
  const categoryColors = {
    ...
    Ideas: "bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300",
  ...
  const feelingColors = {
    ...
    Happy: "bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300",
    Excited: "bg-orange-100 text-orange-700 dark:bg-orange-900 dark:text-orange-300",
    Grateful: "bg-emerald-100 text-emerald-700 dark:bg-emerald-900 dark:text-emerald-300",
    Motivated: "bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300",
    ...
    Inspired: "bg-violet-100 text-violet-700 dark:bg-violet-900 dark:text-violet-300",

    Lonely: "bg-indigo-100 text-indigo-700 dark:bg-indigo-900 dark:text-indigo-300",
    Sad: "bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300",
    Heartbroken: "bg-rose-100 text-rose-700 dark:bg-rose-900 dark:text-rose-300",
    Disappointed: "bg-gray-200 text-gray-800 dark:bg-gray-800 dark:text-gray-300",
    Anxious: "bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300",
    Worried: "bg-amber-100 text-amber-700 dark:bg-amber-900 dark:text-amber-300",
    Overwhelmed: "bg-rose-200 text-rose-800 dark:bg-rose-950 dark:text-rose-300",
    Exhausted: "bg-slate-200 text-slate-800 dark:bg-slate-800 dark:text-slate-300",

    Angry: "bg-red-200 text-red-800 dark:bg-red-950 dark:text-red-300",
    Frustrated: "bg-orange-200 text-orange-800 dark:bg-orange-950 dark:text-orange-300",
    Confused: "bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300",
    Overthinking: "bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300",
    ...
    Crush: "bg-fuchsia-100 text-fuchsia-700 dark:bg-fuchsia-900 dark:text-fuchsia-300",
    ...
    Breakup: "bg-stone-200 text-stone-800 dark:bg-stone-800 dark:text-stone-300",

    Healing: "bg-emerald-100 text-emerald-700 dark:bg-emerald-900 dark:text-emerald-300",
    Learning: "bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300",
    Focused: "bg-indigo-100 text-indigo-700 dark:bg-indigo-900 dark:text-indigo-300",
    "Self Growth": "bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300",
    ...
    Confession: "bg-stone-100 text-stone-700 dark:bg-stone-800 dark:text-stone-300",
    Fantasy: "bg-purple-200 text-purple-800 dark:bg-purple-950 dark:text-purple-300",
    Memory: "bg-yellow-50 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300",
    "Random Thoughts": "bg-teal-50 text-teal-800 dark:bg-teal-900 dark:text-teal-300",
    ...
    Gaming: "bg-violet-100 text-violet-700 dark:bg-violet-900 dark:text-violet-300",
    Music: "bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300",
    Movies: "bg-indigo-100 text-indigo-700 dark:bg-indigo-900 dark:text-indigo-300",
    Photography: "bg-pink-100 text-pink-700 dark:bg-pink-900 dark:text-pink-300",
      ...
      <div className="flex justify-between items-start mb-4">
        <div className="flex-1 pr-2">
          ...
          <div className="flex flex-wrap gap-2 mt-2">
            ...
            >
              {categoryEmojis[note.category] || "📒"} {note.category || "General"}
            </span>
